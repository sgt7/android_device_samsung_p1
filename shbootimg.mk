...
$(INSTALLED_P1L_BOOTIMAGE_TARGET): $(PRODUCT_OUT)/utilities/flash_image $(PRODUCT_OUT)/utilities/busybox $(PRODUCT_OUT)/utilities/make_ext4fs $(PRODUCT_OUT)/utilities/erase_image
	$(hide) $(ACP) -fp $< $@
	$(MAKE) $(INSTALLED_KERNEL_TARGET) TARGET_KERNEL_CONFIG=cyanogenmod_p1l_defconfig KERNEL_OUT=$(TARGET_OUT_INTERMEDIATES)/KERNEL_P1L_OBJ
...
$(INSTALLED_P1N_BOOTIMAGE_TARGET): $(PRODUCT_OUT)/utilities/flash_image $(PRODUCT_OUT)/utilities/busybox $(PRODUCT_OUT)/utilities/make_ext4fs $(PRODUCT_OUT)/utilities/erase_image
	$(hide) $(ACP) -fp $< $@
	$(MAKE) $(INSTALLED_KERNEL_TARGET) TARGET_KERNEL_CONFIG=cyanogenmod_p1n_defconfig KERNEL_OUT=$(TARGET_OUT_INTERMEDIATES)/KERNEL_P1N_OBJ
...
$(INSTALLED_BOOTIMAGE_TARGET): $(INSTALLED_P1_BOOTIMAGE_TARGET) $(INSTALLED_P1L_BOOTIMAGE_TARGET) $(INSTALLED_P1N_BOOTIMAGE_TARGET)
